    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#f4f6f8] font-sans p-4 md:p-8" dir="rtl">
            ...
            <main className="w-full max-w-[1400px] min-h-[85vh] bg-[#f4f6f8] rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] relative">
                ...
                {/* ===== LEFT: Form Panel ===== */}
                <section className="w-full md:w-[45%] lg:w-[42%] bg-[#FFFFFF] flex flex-col justify-center px-8 md:px-14 lg:px-20 py-10 relative z-10 rounded-l-[2rem] md:rounded-l-none md:rounded-r-[2.5rem] m-4 md:m-0 md:my-8 md:-ml-6 shadow-2xl h-auto md:min-h-[calc(85vh-4rem)]">
