        ...
        >
            ...
            >
                ...
                <div 
                    ...
                    className={`bg-white rounded-3xl p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] cursor-pointer flex flex-col justify-between transition-all duration-300 group relative overflow-hidden ${
                        statusFilter === 'Active' 
